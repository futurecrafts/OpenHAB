...
#define SERIAL_BAUD 9600  //must be 9600 for GPS
...
// water leak sensor ==========================================
//int waterInput = 8;   //pin for water detection
...
long GPS_lati, GPS_long;		// GPS Latitude and Longitude
...
//GPS setup stuff
// RX, TX;  Pin 4 (RX) of Arduino goes to RX of GPS
...
//  send53 = true;          // Ultrasonic
    send62 = true;			// GPS-normal, latitude
	send63 = true;			// GPS-normal, longitude
...
break;
case (62):            // GPS-normal, latitude
if (mes.cmd == 1) send62 = true;
break;
case (63):            // GPS-normal, longitude
...
if (send62 && send63) {           // GPS-normal, latitude and longitude
  if (mySerial.available())
  {
    char c = mySerial.read();
#ifdef DEBUG  
    //Serial.println("New GSP Data available!");
	//Serial.print(c);  //raw GPS data
#endif
    if (gps.encode(c))
	{
#ifdef DEBUG  
